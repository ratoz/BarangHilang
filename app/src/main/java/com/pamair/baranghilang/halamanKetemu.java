...
public class halamanKetemu extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view_fragment = inflater.inflate(R.layout.halaman_ketemu, container, false);

        // ---------- Pengaturan Recycle View ----------
        recyclerView = view_fragment.findViewById(R.id.postketemu);
